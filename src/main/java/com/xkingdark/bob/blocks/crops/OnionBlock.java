...
public class OnionBlock extends CropBlock {
    public static final MapCodec<OnionBlock> CODEC = createCodec(OnionBlock::new);
    ...
    private static final VoxelShape[] AGE_TO_SHAPE = new VoxelShape[]{
        ...
        Block.createCuboidShape(4.0, 0.0, 4.0, 12.0, 14.0, 12.0),
    ...
    @Override
    public MapCodec<OnionBlock> getCodec() {
        return CODEC;
    }
