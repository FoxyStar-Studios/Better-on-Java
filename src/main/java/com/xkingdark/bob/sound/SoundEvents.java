...
public class SoundEvents {
    public static final RegistryEntry.Reference<SoundEvent> MUSIC_DISC_FOX = registerReference("music_disc.fox");
    public static final RegistryEntry.Reference<SoundEvent> MUSIC_DISC_STARDUST = registerReference("music_disc.stardust");
    public static final RegistryEntry.Reference<SoundEvent> MUSIC_DISC_STELLAR_CRYSTALS = registerReference("music_disc.stellar_crystals");
    public static final RegistryEntry.Reference<SoundEvent> MUSIC_DISC_TRAVELERS = registerReference("music_disc.travelers");
